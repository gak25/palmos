...
ActiveRecord::Schema.define(version: 20180213233434) do
  ...
  create_table "sensors", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.string "sensor_latitude", default: "42.3815", null: false
    t.string "sensor_longitude", default: "-71.1051", null: false
    ...
    t.float "sensor_angle", limit: 24, default: 0.0
